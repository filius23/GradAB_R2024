...
-   `matches()`: Variable selection using [*regular expressions*](https://jfjelstul.github.io/regular-expressions-tutorial/), see `select(dat1,matches("b$"))`: all variables ending on a `b`

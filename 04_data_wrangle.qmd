...
What’s with the `~`[^tilde] in `across()`? Let's take a look at the basics of functions in R to understand.
...
+ Continue using the university dataset `dat3` as [shown above](#var) from `dat1` and `dat2`.
